    ...
    public static void main(String[] args) {
        ...
        do{
            ...
            switch(opcion){
                ...
                case 7 : int opcion3 = JOptionPane.showConfirmDialog(null,"Está seguro de eliminar el nodo final: ?");
                    if (opcion3 == JOptionPane.YES_OPTION){
                        list.eliminarAlFinal();
                        JOptionPane.showMessageDialog(null, "* Elemento Eliminado con Éxito * \nLista Resultante: " + list);
                    }
                    break;
                case 8: //Código de Búsqueda.
                    break;
                case 9 : JOptionPane.showMessageDialog(null, "LISTA CONCATENADA\n"+list);
                    break;
                default :break;
